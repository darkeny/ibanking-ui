...
import PrepaidCards from '../pages/Business/PrepaidCards';
    ...
    return (
        <Router>
            <Routes>
                ...
                {/* Rotas dos cartões pré-pagos e checks */}
                <Route path="/business/prepaid-cards" element={<PrepaidCards language={"PT"} />} />
