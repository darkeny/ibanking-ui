// pages/BusinessGenericPage.tsx
import React from 'react';
import { useLocation } from 'react-router-dom';
import { CiCreditCard1 } from "react-icons/ci";
import { BusinessLayout } from '../../../components/BusinessLayout';

interface BusinessGenericPageProps {
    language: 'PT' | 'EN';
}

const BusinessGenericPage: React.FC<BusinessGenericPageProps> = ({ language }) => {
...
export default BusinessGenericPage;