// pages/ClientServicePayments.tsx
...
interface ClientServicePaymentsProps {
    language: 'PT' | 'EN';
}
...
const ClientServicePayments: React.FC<ClientServicePaymentsProps> = ({ language }) => {
...
export default ClientServicePayments;