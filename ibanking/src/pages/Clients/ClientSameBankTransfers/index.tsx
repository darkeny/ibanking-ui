// pages/ClientSameBankTransfers.tsx
...
const ClientSameBankTransfers: React.FC = () => {
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="font-semibold text-blue-600">Your Bank ✅</span>
                                        </div>
                                        <div className="flex justify-between items-center">
                                ...
                                <div className="text-center space-y-6">
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-4 space-y-2 text-sm">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="text-blue-600 font-semibold">Your Bank ✅</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Categoria:</span>
...
export default ClientSameBankTransfers;